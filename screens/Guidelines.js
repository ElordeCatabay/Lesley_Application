  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.guidelineContainer}>
        ...
        <Text style={styles.guidelineText}>Slider for reviewer</Text>
        <Text style={styles.guidelineText}>see some Latest Reviewer</Text>
        <Text style={styles.guidelineText}>
          Description: Use the slider to see some latest reviewer and all the
          available reviewer for IT students
        </Text>
      </View>
      ...
      <View style={styles.guidelineContainer}>
        ...
        <Text style={styles.guidelineText}>
          It will show all the available Latest Reviewer
        </Text>
        <Text style={styles.guidelineText}>
        ...
        <Text style={styles.guidelineText}>
          ...
          can review when you click some available reviewer in the reviewer
          buttons.
        </Text>
      </View>
      <View style={styles.guidelineContainer}>
